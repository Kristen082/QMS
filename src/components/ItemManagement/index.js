...
export default class User extends Component {
    ...
    this.state = {
      ...
      columns: [
        ...
        },
        {
          ...
          ...self.getColumnSearchProps('ItemNo'),
        },
        {
          title: 'Item Desc.',
          dataIndex: 'ItemDesc',
          width: 150,
          sorter: (a, b) => a.ItemDesc - b.ItemDesc,
          ...self.getColumnSearchProps('ItemDesc'),
        },
        {
          title: 'Routing',
          dataIndex: 'Routing',
          ...
          ...self.getColumnSearchProps('Routing'),
        }
      ]
    }
  ...
  handleReset = clearFilters => {
    ...
    componentDidMount(){
      axios.post('/api/BaseProcess/GetProcessList',{
        "isPagination": true,
